...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmljaGVlayIsImEiOiJja3BvYWE1cnEwMHhmMnZxcTdqdXI1MHlwIn0.HCqoy80BKMAi45YnlhKVTA';
  ...
  var bounds = new mapboxgl.LngLatBounds(); // console.log(locations);
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Include map bounds to include current location
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); // if (el) el.parentElement.removeChild(el);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            // Reload the home route after 1500ms if the user is logged in
...
var stripe = Stripe('pk_test_51J3c0tSH1fxnLqHVlt6up1JUeP0viQDYURytObO35IHms8we26qReT81BIXFYKftYaczs2bJFSz6fRzHohJxuM8Q00QDi1WV2h'); // const stripe = Stripe(
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault(); // prevents the form from loading the page
    // VALUES
