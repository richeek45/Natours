...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // (In case the user token is stolen and the user has changed its password )
...
exports.isLoggedIn = async (req, res, next) => {
  ...
  if (req.cookies.jwt) {
    try {
      ...
      // res.locals -> passing data into the template
      res.locals.user = currentUser;
      return next();
    } catch (err) {
      return next();
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // const message = `Forgot your password? Submit your patch request with
